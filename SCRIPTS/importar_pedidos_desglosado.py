...
#  ✅ Convertir columna de fecha (auto-detección) y normalizar a YYYY-MM-DD
if "fecha" in df_pedidos.columns:
    ...
    # 2) intentar parseo automático; mantiene cualquier formato ISO ya correcto
    df_pedidos["fecha"] = (
...
try:
    with engine.begin() as conn:
        ...
        # ✅ Filtrar columnas válidas antes de insertar

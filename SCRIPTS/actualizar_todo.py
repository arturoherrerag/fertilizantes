...
# Scripts de importación y actualización en orden
scripts_importacion = [
    "importar_red.py",
...
try:
    ...
    with engine.begin() as conn:
        ...
        """))
        print(f"✅ Registros actualizados (CHIAPAS y OAXACA): {result.rowcount}\n")
except Exception as e:
    print(f"❌ Error al actualizar superficie_apoyada para CHIAPAS y OAXACA: {e}")
...
try:
    print("🛠️ Actualizando superficie_apoyada desde padrones para SINALOA...\n")
    with engine.begin() as conn:
        result = conn.execute(text("""
        ...
        """))
        print(f"✅ Registros actualizados (SINALOA): {result.rowcount}\n")
except Exception as e:
    print(f"❌ Error al actualizar superficie_apoyada para SINALOA: {e}")
...
vistas_materializadas = [
    ...
    "mv_fletes_enriquecidos",
    "avance_apoyados_2025_por_listado",
    "avance_apoyados_2025_listado_ceda",
    "avance_apoyados_2025_listado_estado",
    "mv_metas_ceda_estatus_2025",
    "mv_avances_diarios_ceda_estatus_2025",
    "mv_meta_y_avance_ceda_estatus_2025",
    "inventarios_quien_reporta_resumen",
]
